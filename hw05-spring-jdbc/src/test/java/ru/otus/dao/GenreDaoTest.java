...
public class GenreDaoTest {
    ...
    @Test
    @DisplayName("Выбрать все жанры c айди книг")
    void getAllGenresWithBooIdTest() {
        var allGenresWithBooId = genreDao.getAllGenresWithBooId();
        assertThat(allGenresWithBooId).isNotEmpty();
    }
