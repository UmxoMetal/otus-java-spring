...
public class TestServiceImpl implements TestService {
    ...
    public void runTest() {
        printService.printMsg(localizationService.getLocalizationTextByTag("msg.enter.name"));
        var name = consoleInputService.readString();

        printService.printMsg(localizationService.getLocalizationTextByTag("msg.enter.surname"));
        ...
        var totalScore = questionService.getAllQuestions()
                ...
                .mapToInt(question -> {
                    ...
                    printService.printMsg(localizationService.getLocalizationTextByTag("msg.enter.answer"));
